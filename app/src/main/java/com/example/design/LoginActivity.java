                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.child(parentDbName).child(phone).exists())
                        {
                            ...
                            if(usersData.getPhone().equals(phone))
                            {
                                ...
                                {
                                    loadingBar.dismiss();
                                    Toast.makeText(LoginActivity.this, "THE PASSWORD IS INORRECT", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                        else
                        {
                            Toast.makeText(LoginActivity.this,"Account with "+phone+" doesnot exist",Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
